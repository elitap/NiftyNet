...
def create_lineplot_organ_samp_avg_model_filtered(result_file, stage, filters, value='Dice', threshold=0.4):
    ...
    grouped_df = full_df.groupby(['Model', 'Checkpoint'])[value].mean() #mean over organs
...
if __name__ == "__main__":
    ...
    create_lineplot_organ_samp_avg_model_filtered(result, stage, ['gdsc'], value='Spec', threshold=0.2)
