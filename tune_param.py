...
DONE = ["quarter_e-5_48-8_gdsc_50k_1024s.ini", "full_e-3_96-1_dice_50k_1024s.ini", "full_e-5_96-1_dice_50k_1024s.ini",
        ...
        "full_e-3_48-8_dice_50k_1024s.ini", "half_e-3_48-8_gdsc_50k_1024s.ini", "full_e-5_96-1_gdsc_50k_1024s.ini",
        ...
        "half_e-4_96-1_dice_50k_1024s.ini", "half_e-4_96-1_gdsc_50k_1024s.ini", "half_e-5_48-8_gdsc_50k_1024s.ini"]

#"full_e-5_96-1_dice_50k_1024s.ini"
#"half_e-3_96-1_dice_50k_1024s.ini",
#"full_e-3_48-8_dice_50k_1024s.ini",
...
def run_tests(gpu, pc):
    with open("tune_models/log/tune_log_gpu"+str(gpu)+".txt", "a") as fptr:
        ...
        for file in os.listdir(CONFIGS):
            if os.path.splitext(file)[1] in ENDING:
                ...
                if file not in DONE and ((pc == 0 and file in MYPC) or (pc == 1 and file in OTHERPC)):
                    if (gpu == 0 and "dice" in file) or (gpu == 1 and "gdsc" in file):
