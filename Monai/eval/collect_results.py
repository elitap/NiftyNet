...
try:
    ...
    from eval import defs


OUTPUT_FILE_KEY = "_seg"
RESULT_SUB_DIR = "output/"
ID_IDX = 10
ID_IDX_TCIA = 11
...
def get_plastimatch_results(gt_itk, gt_organ_np, result_itk, result_organ_np,
    ...
    if with_sd:
        surface_distances = sd.compute_surface_distances(
            gt_organ_np, result_organ_np, spacing_mm=gt_itk.GetSpacing())
        tau = defs.tau[organ]
...
if __name__ == "__main__":
    ...
    parser.add_argument('--gtdir',
                        required=False,
                        default='data/HaN_MICCAI2015_Dataset/full_dataset_orig'
                        )
